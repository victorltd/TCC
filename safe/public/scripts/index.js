...
const chartsDivElement = document.querySelector('#charts-div'); //constante que altera as coisas do grafico
...
const setupUI = (user) => {
  if (user) {
    ...
    /* se eu comentar aqui, para de enviar novos valores de range para o firebase
